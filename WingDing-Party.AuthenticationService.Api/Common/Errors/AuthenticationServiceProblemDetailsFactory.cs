...
namespace WingDing_Party.AuthenticationService.Api.Common.Errors;

public class AuthenticationServiceProblemDetailsFactory 
    : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _options;
    private readonly IHostEnvironment? _environment;

    public AuthenticationServiceProblemDetailsFactory(
